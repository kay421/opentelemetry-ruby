...
module OpenTelemetry
  module Instrumentation
    module Sequel
      module Patches
        # Module to prepend to Sequel::Connection for instrumentation
        module Connection
          ...
          Sequel::Constants::PREPARE_ISH_METHODS.each do |method|
            define_method method do |*args|
          ...
          Sequel::Constants::EXEC_PREPARED_ISH_METHODS.each do |method|
            define_method method do |*args|
